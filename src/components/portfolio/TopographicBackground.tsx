...
const TopographicBackground = () => {
  return (
    <div className="fixed inset-0 z-[-1] overflow-hidden pointer-events-none bg-[#0a0a0a]">
      {/* Dark Forest Background Image Overlay */}
      <div 
      ...
      {/* Dark gradient overlay for bottom and top */}
      <div className="absolute inset-0 bg-gradient-to-b from-black/50 via-transparent to-background/95" />
    </div>
  );
};
